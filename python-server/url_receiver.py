...
class Receiver:
        ...
        for message in message_list:
            ...
            if (message['author']['username'] == 'Midjourney Bot') and ('**' in message['content']):
                ...
                if len(message['attachments']) > 0:
                    ...
                    if (message['attachments'][0]['filename'][-4:] == '.png') or ('(Open on website for full qua>
                        id = message['id']
    ...
    def outputer(self):
        ...
        waiting_for_download = [self.df.loc[i].prompt for i in self.df.index if self.df.loc[i].is_downloaded == >
